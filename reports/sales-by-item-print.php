    ...
    <div class="invoice-box">
            ...
            <div class="bill-to">
                ...
                <div style="background: #f9f9f9; padding: 15px; border-radius: 6px;">
                    <table style="width: 100%; border-collapse: collapse;">
                        <tr>
                            <td style="padding: 5px; font-size: 12px; color: #666;"><strong>Total Items:</strong></td>
                            <td style="padding: 5px; text-align: right; font-size: 12px; color: #333;"><?php echo $totalItems; ?></td>
                        </tr>
                        <tr>
                            <td style="padding: 5px; font-size: 12px; color: #666;"><strong>Times Sold:</strong></td>
                            <td style="padding: 5px; text-align: right; font-size: 12px; color: #333;"><?php echo $totalTimesSold; ?></td>
                        </tr>
                        <tr>
                            <td style="padding: 5px; font-size: 12px; color: #666;"><strong>Total Quantity:</strong></td>
                            <td style="padding: 5px; text-align: right; font-size: 12px; color: #333;"><?php echo number_format($totalQuantity, 2); ?></td>
                        </tr>
                        <tr>
                            <td style="padding: 5px; font-size: 12px; color: #666;"><strong>Total Revenue:</strong></td>
                            <td style="padding: 5px; text-align: right; font-size: 12px; color: #333;"><?php echo CURRENCY_SYMBOL; ?><?php echo number_format($totalRevenue, 2); ?></td>
                        </tr>
                    </table>
                </div>
            </div>
        ...
        <table>
            ...
            <tbody>
                <?php if (empty($salesByItem)): ?>
                    <tr>
                        <td colspan="6" style="text-align: center; color: #666;">No sales data found for this period.</td>
                    </tr>
                <?php else: ?>
                    ...
                    <tr>
                        ...
                        <td><?php echo htmlspecialchars($item['times_sold']); ?></td>
                        <td><?php echo number_format($item['total_quantity'], 2); ?></td>
                        <td><?php echo CURRENCY_SYMBOL; ?><?php echo number_format($item['avg_price'], 2); ?></td>
                        <td><?php echo CURRENCY_SYMBOL; ?><?php echo number_format($item['total_revenue'], 2); ?></td>
                    </tr>
                    <?php endforeach; ?>
                <?php endif; ?>
            </tbody>
        ...
        <table class="totals">
            <tr>
                ...
                <td class="value"><?php echo number_format($totalQuantity, 2); ?></td>
            </tr>
            <tr>
                <td class="label"><strong>Total Revenue</strong></td>
                <td class="value"><strong><?php echo CURRENCY_SYMBOL; ?><?php echo number_format($totalRevenue, 2); ?></strong></td>
            </tr>
        </table>
