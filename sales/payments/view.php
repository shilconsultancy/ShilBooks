    ...
    <header class="bg-white border-b border-macgray-200 py-3 px-6 flex items-center justify-between">
        ...
        <div class="flex items-center space-x-2">
            <a href="<?php echo BASE_PATH; ?>sales/payments/" class="text-sm text-macblue-600 hover:text-macblue-800">
             ...
             <a href="print.php?id=<?php echo $payment_id; ?>" target="_blank" class="px-3 py-2 bg-macblue-500 text-white rounded-md hover:bg-macblue-600 flex items-center space-x-2 text-sm">
            ...
            <div class="bg-white p-8 rounded-xl shadow-sm border border-macgray-200">
                <div class="grid grid-cols-1 md:grid-cols-3 gap-6 border-b pb-6">
                    ...
                    <div>
                        ...
                        <p class="text-2xl font-bold text-green-600"><?php echo CURRENCY_SYMBOL; ?><?php echo htmlspecialchars(number_format($payment['amount'], 2)); ?></p>
                    </div>
                </div>
                            ...
                            <tbody class="divide-y divide-macgray-200">
                                ...
                                <?php else: ?>
                                    ...
                                    <tr>
                                        ...
                                        <td class="px-4 py-3 text-right font-medium text-macgray-800"><?php echo CURRENCY_SYMBOL; ?><?php echo htmlspecialchars(number_format($link['amount_applied'], 2)); ?></td>
                                    </tr>
                                    <?php endforeach; ?>
                                <?php endif; ?>
                            </tbody>
