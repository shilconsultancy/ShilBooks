                    ...
                    <table class="min-w-full divide-y divide-macgray-200">
                        ...
                        <tbody class="divide-y divide-macgray-200">
                            <?php if (empty($invoices)): ?>
                                <tr>
                                    <td colspan="6" class="px-6 py-4 text-center text-macgray-500">No invoices found. Create one to get started.</td>
                                </tr>
                            <?php else: ?>
                                <?php foreach ($invoices as $invoice): ?>
                                    <tr>
                                        ...
                                        <td class="px-6 py-4 whitespace-nowrap text-sm text-macgray-900">৳<?php echo htmlspecialchars(number_format($invoice['total'], 2)); ?></td>
                                        <td class="px-6 py-4 whitespace-nowrap text-sm">
                                            <span class="px-2 py-1 text-xs font-medium rounded-full <?php echo getStatusBadgeClass($invoice['status']); ?>">
