...
$pageTitle = 'Print Sales Receipt ' . htmlspecialchars($receipt['receipt_number']);
?>
<!DOCTYPE html>
<html lang="en">
<head>
    ...
    <div class="max-w-4xl mx-auto my-8 bg-white p-10 shadow-lg">
        ...
        <header class="flex justify-between items-start pb-4 border-b">
            ...
            <div class="w-1/2 text-right">
                <h2 class="text-4xl font-bold uppercase text-gray-800">Receipt</h2>
                <p class="text-gray-500 mt-2">#<?php echo htmlspecialchars($receipt['receipt_number']); ?></p>
            </div>
        </header>
        ...
        <section class="mt-8 flex justify-between">
            <div>
                ...
                <p class="font-bold text-gray-800"><?php echo htmlspecialchars($receipt['customer_name']); ?></p>
                <p class="text-gray-600"><?php echo nl2br(htmlspecialchars($receipt['customer_address'])); ?></p>
            </div>
            <div class="text-right">
                <p class="font-semibold text-gray-500">Receipt Date:</p>
                <p class="text-gray-800"><?php echo htmlspecialchars(date("M d, Y", strtotime($receipt['receipt_date']))); ?></p>
            </div>
        </section>
        ...
        <section class="mt-8 flex justify-end">
            <div class="w-full max-w-sm">
                <div class="space-y-3">
                    <div class="flex justify-between"><span class="font-medium text-gray-500">Subtotal</span><span class="text-gray-800"><?php echo CURRENCY_SYMBOL; ?><?php echo number_format($receipt['subtotal'], 2); ?></span></div>
                    <div class="flex justify-between"><span class="font-medium text-gray-500">Tax</span><span class="text-gray-800"><?php echo CURRENCY_SYMBOL; ?><?php echo number_format($receipt['tax'], 2); ?></span></div>
                    <div class="flex justify-between pt-2 border-t bg-gray-100 p-2">
                        <span class="text-lg font-bold text-gray-900">Total Paid</span>
                        <span class="text-lg font-bold text-gray-900"><?php echo CURRENCY_SYMBOL; ?><?php echo number_format($receipt['total'], 2); ?></span>
                    </div>
                </div>
            </div>
        </section>
