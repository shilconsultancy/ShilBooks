                 ...
                 <div class="mt-6 grid grid-cols-1 md:grid-cols-2 gap-6">
                    ...
                    <div class="bg-white p-6 rounded-xl shadow-sm border border-macgray-200">
                        <div class="space-y-4">
                            ...
                            <div class="flex justify-between items-center"><span class="text-sm font-medium text-gray-500">Tax (0%)</span><span id="tax-display"><?php echo CURRENCY_SYMBOL; ?>0.00</span></div>
                            <hr>
...
document.addEventListener('DOMContentLoaded', function() {
    ...
    function calculateTotals() {
        ...
        document.getElementById('tax-display').innerText = currencySymbol + tax.toFixed(2);
