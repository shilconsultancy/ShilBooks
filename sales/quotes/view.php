...
if (!$quote) {
    // Quote not found or doesn't belong to the user
    header("location: index.php");
    exit;
}
...
<div class="flex-1 flex flex-col overflow-hidden">
    <header class="bg-white border-b border-macgray-200 py-3 px-6 flex items-center justify-between">
        ...
        <div class="flex items-center space-x-4">
            <a href="<?php echo BASE_PATH; ?>sales/quotes/" class="text-sm text-macblue-600 hover:text-macblue-800">
                &larr; Back to All Quotes
            </a>
            <a href="edit.php?id=<?php echo $quote_id; ?>" class="px-4 py-2 bg-macblue-500 text-white rounded-md hover:bg-macblue-600 transition-colors flex items-center space-x-2 text-sm">
        ...
        <div class="max-w-4xl mx-auto">
            ...
            <div class="bg-white p-8 rounded-xl shadow-sm border border-macgray-200">
                <div class="flex justify-between items-start pb-4 border-b">
                    <div>
                        <h2 class="text-2xl font-bold text-macgray-900">QUOTE</h2>
                        <p class="text-macgray-500">#<?php echo htmlspecialchars($quote['quote_number']); ?></p>
                    </div>
                ...
                <div class="flex justify-between items-start mt-6">
                    <div>
                        ...
                        <p class="font-bold text-macgray-800"><?php echo htmlspecialchars($quote['customer_name']); ?></p>
                        <p class="text-sm text-macgray-500"><?php echo nl2br(htmlspecialchars($quote['customer_address'])); ?></p>
                        <p class="text-sm text-macgray-500"><?php echo htmlspecialchars($quote['customer_email']); ?></p>
                    </div>
                    <div class="text-right">
                        <div class="grid grid-cols-2 gap-x-4">
                            <p class="font-semibold text-macgray-500">Quote Date:</p>
                            <p class="text-macgray-800"><?php echo htmlspecialchars(date("M d, Y", strtotime($quote['quote_date']))); ?></p>
                            <p class="font-semibold text-macgray-500">Expiry Date:</p>
                            <p class="text-macgray-800"><?php echo htmlspecialchars(date("M d, Y", strtotime($quote['expiry_date']))); ?></p>
                        </div>
                    </div>
                </div>
                    ...
                    <table class="min-w-full">
                        <thead class="border-b-2 border-macgray-200">
                            <tr>
                                ...
                                <th class="px-2 py-3 text-left text-xs font-semibold text-macgray-500 uppercase tracking-wider">Description</th>
                        ...
                        <tbody class="divide-y divide-macgray-100">
                            ...
                            <tr>
                                <td class="px-2 py-4 whitespace-nowrap text-sm font-medium text-macgray-800"><?php echo htmlspecialchars($item['item_name']); ?></td>
                                <td class="px-2 py-4 whitespace-nowrap text-sm text-macgray-500"><?php echo htmlspecialchars($item['description']); ?></td>
                    ...
                    <div class="w-full max-w-xs">
                        <div class="space-y-2">
                            <div class="flex justify-between">
                                <span class="text-sm font-medium text-macgray-500">Subtotal</span>
                                <span class="text-sm text-macgray-800">৳<?php echo htmlspecialchars(number_format($quote['subtotal'], 2)); ?></span>
                            </div>
                            <div class="flex justify-between">
                                <span class="text-sm font-medium text-macgray-500">Tax</span>
                                <span class="text-sm text-macgray-800">৳<?php echo htmlspecialchars(number_format($quote['tax'], 2)); ?></span>
                            </div>
                            <div class="flex justify-between pt-2 border-t">
                                <span class="text-base font-bold text-macgray-900">Total</span>
                                <span class="text-base font-bold text-macgray-900">৳<?php echo htmlspecialchars(number_format($quote['total'], 2)); ?></span>
                            </div>
                        </div>
                    </div>
                </div>
                ...
                <div class="mt-8 pt-4 border-t">
                    ...
                    <p class="text-sm text-macgray-500 mt-2"><?php echo nl2br(htmlspecialchars($quote['notes'])); ?></p>
                </div>
                <?php endif; ?>
            </div>
        </div>
